        ...
        <div className="p-4 space-y-4 h-[80vh] overflow-y-auto">
            ...
            <div className="text-center space-y-2">
                ...
                <button
                    ...
                    className="inline-flex items-center px-4 py-2 bg-blue-700 hover:bg-blue-600 text-white text-sm font-medium rounded transition-colors duration-200 shadow-sm hover:shadow-md"
                >
