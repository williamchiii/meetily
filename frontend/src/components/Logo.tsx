  ...
  return (
    <Dialog aria-describedby={undefined}>
      {isCollapsed ? (
        ...
        <DialogTrigger asChild>
          <span className="text-lg text-center border rounded-full bg-blue-50 border-blue-200 font-semibold text-gray-700 mb-2 block items-center cursor-pointer hover:opacity-80 transition-opacity">
            <span>Meetily</span>
          </span>
        </DialogTrigger>
      )}
